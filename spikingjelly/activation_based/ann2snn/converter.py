from activation_based.ann2snn.modules import *
from tqdm import tqdm
from activation_based import neuron
import copy
...
class Converter(nn.Module):
    ...
    def forward(self, relu_model):
        ...
        # print(list(enumerate(tqdm(self.dataloader))))
        # print("-----------------------------------------")
        for _, (imgs, _, _, _) in enumerate(tqdm(self.dataloader)):  #这里如果是yolov5读取的datalodaer则需要三个_
            model(imgs.to(torch.float32).to(self.device))
